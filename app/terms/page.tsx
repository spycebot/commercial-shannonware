...
import { FS } from '@/components/tokens';
...
export default function TermsPage() {
  return (
    <StaticPage label="TERMS OF USE" title="Terms of Use">
      ...
      <h3 style={{ fontFamily: 'inherit', fontSize: FS.heading, color: 'inherit', marginTop: 24, marginBottom: 8 }}>Advisory</h3>
      <p>Google anonymised usage statistics cookies are used on this site.</p>
      <h3 style={{ fontFamily: 'inherit', fontSize: FS.heading, color: 'inherit', marginTop: 24, marginBottom: 8 }}>Disclaimer</h3>
